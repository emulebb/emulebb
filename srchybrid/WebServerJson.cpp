...
json BuildFakeFileReportJson(const SFakeFileReport &rReport)
{
	return json{
		...
		{"canonicalNames", BuildStringArrayJson(rReport.astrCanonicalNames)},
		{"ignoredNameTokens", BuildStringArrayJson(rReport.astrIgnoredNameTokens)},
		{"nameDivergenceGroups", BuildStringArrayJson(rReport.astrNameDivergenceGroups)},
