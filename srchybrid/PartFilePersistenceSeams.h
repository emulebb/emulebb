...
#define EMULEBB_TEST_HAVE_PART_FILE_PERSISTENCE_SEAMS 1
#define EMULEBB_TEST_HAVE_PART_FILE_DISKSPACE_FLOOR_SEAMS 1
#define EMULEBB_TEST_HAVE_PART_FILE_DELETE_PLAN_SEAMS 1
