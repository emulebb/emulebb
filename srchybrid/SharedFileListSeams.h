...
#define EMULEBB_TESTS_HAS_SHARED_FILE_LIST_PATH_SEAMS 1
#define EMULEBB_TESTS_HAS_SHARED_FILE_LIST_ASYNC_HASH_SEAMS 1
#define EMULEBB_TESTS_HAS_SHARED_FILE_LIST_PUBLISH_BATCH_SEAMS 1
