...
private:
	...
	NoRequestRepeatPenalty TrackNoRequestRepeatOffender(CUpDownClient *client, ULONGLONG curTick, UINT uBaseCooldownSeconds, UINT uMaxCooldownSeconds, UINT uBanThreshold);
