...
void DiagEventLogSchedSharedPublishOfferBatch(LPCTSTR pszServer, UINT uEntriesSent, UINT uTotalEntries, UINT uPendingBefore, UINT uOfferLimit, bool bWrapped, LPCTSTR pszFileHashesJson);
