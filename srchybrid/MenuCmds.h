...
#define MP_HM_OPEN_TEMPDIR		10392
#define MP_HM_OPEN_WEBSERVERDIR		10393
#define MP_HM_OPEN_SKINDIR		10394
#define MP_HM_OPEN_TOOLBARDIR		10395
#define MP_HM_OPEN_EXECUTABLEDIR	10396
#define MP_HM_EDIT_STATIC_SERVERS_DAT	10397
#define MP_HM_EDIT_SHAREDDIR_DAT	10398
#define MP_HM_EDIT_MONITORED_SHAREDDIR_DAT 10399
#define MP_HM_EDIT_MONITOR_OWNED_SHAREDDIR_DAT 10400
#define MP_HM_EDIT_SHAREIGNORE_DAT	10401
#define MP_HM_EDIT_CATEGORY_INI		10402
#define MP_HM_EDIT_NOTIFIER_INI		10403
#define MP_HM_EDIT_FILEINFO_INI		10404
#define MP_HM_EDIT_STATISTICS_INI	10405
#define MP_HM_RELOAD_SHAREIGNORE_DAT	10406
#define MP_HM_RESCAN_SHARED_FILES	10407
#define MP_HM_SAVE_PREFERENCES_NOW	10408
#define MP_HM_UPDATE_SERVERMET_FROM_ADDRESSES 10409
#define MP_HM_OPEN_EMULE_LOG		10410
#define MP_HM_OPEN_VERBOSE_LOG		10411
...
#define MP_COPY_FILE_SUMMARY	10452
#define MP_COPY_FILE_SIZE		10412
...
#define MP_HM_COPY_DIAGNOSTIC_SNAPSHOT_JSON	10417
#define MP_HM_COPY_REDACTED_DIAGNOSTIC_SNAPSHOT_JSON	10418
#define MP_PRIOUP				10419
#define MP_PRIODOWN				10420
#define MP_PAUSE_CATEGORY		10421
#define MP_RESUME_CATEGORY		10422
#define MP_STOP_CATEGORY		10423
#define MP_HM_REPAIR_WINDOWS_FIREWALL	10424
#define MP_HM_VIEW_PRESET_STOCK_KEEP_WIDTHS	10425
#define MP_HM_VIEW_PRESET_STOCK_RESET_WIDTHS	10426
#define MP_HM_VIEW_PRESET_EXTENDED_KEEP_WIDTHS	10427
#define MP_HM_VIEW_PRESET_EXTENDED_RESET_WIDTHS	10428
#define MP_HM_VIEW_PRESET_FULL_KEEP_WIDTHS	10429
#define MP_HM_VIEW_PRESET_FULL_RESET_WIDTHS	10430
#define MP_HM_MANAGE_CATEGORIES	10431
#define MP_HM_ENABLE_WINDOWS_LONG_PATHS	10432
#define MP_HM_DEFENDER_EXCLUDE_DOWNLOAD_FOLDERS	10433
#define MP_HM_REFRESH_INTERVAL_FAST	10434
#define MP_HM_REFRESH_INTERVAL_NORMAL	10435
#define MP_HM_REFRESH_INTERVAL_BELOWNORMAL 10436
#define MP_HM_REFRESH_INTERVAL_SLOW	10437
#define MP_HM_REFRESH_INTERVAL_VERYSLOW	10438
#define MP_HM_REFRESH_INTERVAL_PAUSED	10439
#define MP_HM_REGISTER_PROWLARR	10440
#define MP_HM_REGISTER_RADARR	10441
#define MP_HM_RESUME_ALL_DOWNLOADS	10442
#define MP_HM_PAUSE_ALL_DOWNLOADS	10443
#define MP_HM_STOP_ALL_DOWNLOADS	10444
#define MP_HM_CLEAR_COMPLETED_DOWNLOADS	10445
#define MP_EXPAND_ALL_SOURCES	10446
#define MP_COLLAPSE_ALL_SOURCES	10447
#define MP_HM_RESET_DISPLAY		10448
#define MP_HM_REGISTER_SONARR	10449
#define MP_HM_LINK_DOC_FAQ		10453
#define MP_HM_LINK_DOC_SETUP	10454
#define MP_HM_LINK_DOC_NETWORK	10455
#define MP_HM_LINK_DOC_SHARING	10456
#define MP_HM_LINK_DOC_DOWNLOADS_SEARCH	10457
#define MP_HM_LINK_DOC_TOOLS_MENU	10458
#define MP_HM_LINK_DOC_CONTROLLERS_REST	10459
#define MP_HM_LINK_DOC_TROUBLESHOOTING	10460
...
#define MP_SEARCH_HIDE_KNOWN_BASE	11400	// reserve 8 for search "hide from results" presets (clear of the MP_FILTERCOLUMNS block)
#define MP_SEARCH_HIDE_NONE			(MP_SEARCH_HIDE_KNOWN_BASE + 0)
#define MP_SEARCH_HIDE_KNOWN		(MP_SEARCH_HIDE_KNOWN_BASE + 1)
#define MP_SEARCH_HIDE_DOWNLOADED	(MP_SEARCH_HIDE_KNOWN_BASE + 2)
#define MP_SEARCH_HIDE_SHARED		(MP_SEARCH_HIDE_KNOWN_BASE + 3)
#define MP_SEARCH_HIDE_DOWNLOADED_SHARED	(MP_SEARCH_HIDE_KNOWN_BASE + 4)
