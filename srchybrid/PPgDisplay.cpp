...
void CPPgDisplay::UpdateToolTips()
{
	...
	m_toolTip.SetTool(this, IDC_SHOWDWLPERCENT, GetResString(IDS_PPG_DISPLAY_TT_SHOWDWLPERCENT));
	m_toolTip.SetTool(this, IDC_SHOWRATEONTITLE, GetResString(IDS_PPG_DISPLAY_TT_SHOWRATEONTITLE));
	m_toolTip.SetTool(this, IDC_SHOWCATINFO, GetResString(IDS_PPG_DISPLAY_TT_SHOWCATINFO));
	m_toolTip.SetTool(this, IDC_CLEARCOMPL, GetResString(IDS_PPG_DISPLAY_TT_CLEARCOMPL));
	m_toolTip.SetTool(this, IDC_SHOWTRANSTOOLBAR, GetResString(IDS_PPG_DISPLAY_TT_SHOWTRANSTOOLBAR));
	...
	m_toolTip.SetTool(this, IDC_DISABLEKNOWNLIST, GetResString(IDS_PPG_DISPLAY_TT_DISABLEKNOWNLIST));
	m_toolTip.SetTool(this, IDC_DISABLEQUEUELIST, GetResString(IDS_PPG_DISPLAY_TT_DISABLEQUEUELIST));
	m_toolTip.SetTool(this, IDC_SELECT_HYPERTEXT_FONT, GetResString(IDS_PPG_DISPLAY_TT_SELECT_HYPERTEXT_FONT));
	m_toolTip.SetTool(this, IDC_DISABLEHIST, GetResString(IDS_PPG_DISPLAY_TT_DISABLEHIST));
	m_toolTip.SetTool(this, IDC_RESETHIST, GetResString(IDS_PPG_DISPLAY_TT_RESETHIST));
}
