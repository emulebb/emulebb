...
constexpr std::uint32_t kDefaultUploadSlotElasticPercent = 80u;
constexpr std::uint32_t kMaxUploadSlotElasticPercent = 100u;
constexpr float kMinSlowUploadThresholdFactor = 0.10f;
constexpr float kDefaultSlowUploadThresholdFactor = 0.75f;
...
constexpr std::uint32_t kDefaultSlowUploadCooldownSeconds = 30u;
