...
constexpr float kDefaultSlowUploadThresholdFactor = 0.33f;
...
constexpr std::uint32_t kDefaultSlowUploadCooldownSeconds = 120u;
...
constexpr std::uint32_t kDefaultSessionTransferPercent = 55u;
...
constexpr std::uint32_t kDefaultSessionTimeLimitSeconds = 3600u;
